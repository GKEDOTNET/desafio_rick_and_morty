...
$.ajax({
    ...
    success: function(dados){
        ...
        // Buscando os dados do personagem 1
        ...
        $.ajax({
            ...
            url: ep1_p1,
            dataType: "json",
            success: function(dados_eps){
                var nome_ep1_p1 = dados_eps["name"];
                var temp_ep1_p1 = dados_eps["episode"];
                var date_ep1_p1 = dados_eps["air_date"];
                $("#episodios_p1").append(
        ...
        $.ajax({
            ...
            dataType: "json",
            success: function(dados_eps){
                var nome_ep2_p1 = dados_eps["name"];
                var temp_ep2_p1 = dados_eps["episode"];
                var date_ep2_p1 = dados_eps["air_date"];
                $("#episodios_p1").append(
        ...
        $.ajax({
            ...
            dataType: "json",
            success: function(dados_eps){
                var nome_ep3_p1 = dados_eps["name"];
                var temp_ep3_p1 = dados_eps["episode"];
                var date_ep3_p1 = dados_eps["air_date"];
                $("#episodios_p1").append(
        ...
        // Buscando os dados do personagem 2
        ...
        $.ajax({
            ...
            dataType: "json",
            success: function(dados_eps){
                var nome_ep1_p2 = dados_eps["name"];
                var temp_ep1_p2 = dados_eps["episode"];
                var date_ep1_p2 = dados_eps["air_date"];
                $("#episodios_p2").append(
        ...
        $.ajax({
            ...
            dataType: "json",
            success: function(dados_eps){
                var nome_ep2_p2 = dados_eps["name"];
                var temp_ep2_p2 = dados_eps["episode"];
                var date_ep2_p2 = dados_eps["air_date"];
                $("#episodios_p2").append(
        ...
        $.ajax({
            ...
            dataType: "json",
            success: function(dados_eps){
                var nome_ep3_p2 = dados_eps["name"];
                var temp_ep3_p2 = dados_eps["episode"];
                var date_ep3_p2 = dados_eps["air_date"];
                $("#episodios_p2").append(
